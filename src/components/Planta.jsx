      ...
      <table className="hover-table-fixed max-w-[700px] w-full mx-auto bg-gray-900 rounded-lg text-white text-center ,;">
        <thead className = "text-2x1 dark:text-white font-bold text-center">
          <tr className=" bg-gray-700  ">
            <th class="border border-slate-250 " >Administrador</th>
            <th class="border border-slate-250" >Nombre</th>
            <th class="border border-slate-250">Descripcion</th>
            <th class="border border-slate-250">Ubicacion</th>
        ...
        <tbody>
          <tr>
            ...
            <td class="border border-slate-600 text-xs ">Ubicacion01</td>
          ...
          <tr>
            ...
            <td  class="border border-slate-600 ">Ubicacion02</td>
          ...
          <tr>
            ...
            <td  class="border border-slate-600 ">Ubicacion03</td>
          ...
          <tr>
            ...
            <td class="border border-slate-600 ">Ubicacion04</td>
